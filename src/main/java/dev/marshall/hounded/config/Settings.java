...
public record Settings(
    ...
    public static final Settings DEFAULTS = new Settings(
            30, CompassUpdateMode.AUTO, 20, false, false, true, false, true, 300, DisplayMode.BOSSBAR, true, true);
    ...
    public Settings {
        ...
        if (runnerRejoinGraceSeconds < 0) {
            throw new IllegalArgumentException("runnerRejoinGraceSeconds must be >= 0");
        }
